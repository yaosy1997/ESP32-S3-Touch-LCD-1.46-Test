...
static void Picture_create(lv_obj_t * parent);
...
void Lvgl_Example1(void){
  ...
  lv_obj_t * t0 = lv_tabview_add_tab(tv, "picture");
...
void Picture_create(lv_obj_t *parent)
{
  show_bmp("/sdcard/");  // Display the picture from SD card
}
